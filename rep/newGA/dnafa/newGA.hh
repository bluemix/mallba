...
// Problem ----------------------------------------------------------------------------
  ...
  requires class Problem
  {
	public:
		...
		int numOfFragments;          // number of fragments
		double avgLength;            // average length of the input fragments
		int cutoff;                  // overlap threshold
		int * fragmentLength;        // fragments' lengths
		vector<string>* fragments;   // forward direction of the fragments
		vector<string>* description; // description of the fragments (Nombre Del Fragmento)
...
//Solution ----------------------------------------------------------------------------
  ...
  requires class Solution
  {
	...
	private:
		int * fragOrder;     // an order of an individual 
		const Problem& _pbm;
  };
